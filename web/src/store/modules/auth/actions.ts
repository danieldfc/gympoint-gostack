...
export const signInRequest = ({ email, password }: User) =>
...
export const signUpRequest = ({ name, email, password }: User) =>
  action(AuthTypes.SIGN_UP_REQUEST, { name, email, password });

export const signFailure = () =>
  action(AuthTypes.SIGN_FAILURE);
